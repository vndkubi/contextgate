...
const TOKENOPT_NATIVE_PROMPTS: NativePromptTemplate[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "- If the user provides Jira tickets or Confluence pages/URLs, use the available Jira/Confluence MCP tools to read them before the business/test coverage phase. Treat them as requirement evidence, not as a replacement for the code review artifact.",
      ...
      "- Ground requirement coverage in Jira/Confluence evidence when the user provided those artifacts; otherwise mark requirement assumptions explicitly.",
...
function reviewInstructionGraphContent(): string {
  return [
    ...
    "- If the prompt includes Jira tickets or Confluence pages/URLs, use Jira/Confluence MCP tools to read them before business/test coverage review. If unavailable, state that requirement evidence is missing or assumption-based.",
